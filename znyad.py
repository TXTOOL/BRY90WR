...
tele = base64.b85decode("5Y<ac8Q>").decode("utf-8")
generate_code = "9NkIj77C9Y0hk8-7RTg;0E"
key = base64.b85decode(";DqNP2FU54").decode("utf-8")
user_id = base64.b85decode("2Dm?O1-%0M2)P").decode("utf-8")
loop = 1
fake = 0
